...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("absolute bg-neutral-blue-400 w-full h-[50rem] top-[-20rem] z-[-1] left-1/2 rounded-[6rem] xl:h-[52rem] xl:w-[100vw]") }));
    ['absolute', 'bg-neutral-blue-400', 'w-full', 'h-[50rem]', 'top-[-20rem]', 'z-[-1]', 'left-1/2', 'rounded-[6rem]', 'xl:h-[52rem]', 'xl:w-[100vw]',];
    var __VLS_slots;
    var $slots;
